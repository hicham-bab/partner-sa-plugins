...
| **dbt Wizard** | — | Confirmed in docs at `/docs/platform/wizard-overview`. An AI agent for governed data development, in the dbt platform and the terminal. Several surfaces are Beta or Preview — state the release phase. |
...
|---|---|---|
| dbt Canvas | Still fully documented at `/docs/platform/canvas` | — |
